...
case class ESConfig(httpHosts:String, transportHosts:String, index:String,
                    clustername:String)
object DataLoader {
    //以window 下为例，需要替换成自己的路径 ，Linux 下为 /YOU_PATH/resources/movies.csv
    val MOVIE_DATA_PATH = "D:\\DevelopWorkspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\movies.csv"
    val RATING_DATA_PATH = "D:\\DevelopWorkspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\ratings.csv"
    val TAG_DATA_PATH = "D:\\DevelopWorkspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\tags.csv"
